...
## Key Outcomes
* Automated Reporting: Replaced manual data tracking with a dynamic, automated dashboard.
* Enhanced Decision Making: Provided a clear visual representation of data that allows management to identify underperforming sectors quickly.
* Scalability: Built a model that can easily incorporate future data updates with minimal manual intervention.
